import { r as registerInstance, h, e as Host, g as getElement } from './index-4e2e0b0d.js';
import { L as Logger, g as getFeedsSingleObserver } from './fetch-es6.worker-3eaebeac.js';
import { f as from, E as EMPTY, p as map } from './index-ae00f5bb.js';
import { t as toArray } from './index-1d6f5d2a.js';
...
const News = class {
  ...
  render() {
    ...
    return (h(Host, { title: this.getTitleText(), alt: this.getAltText(), tabindex: this.hasNoFeeds() ? -1 : this.taborder, class: this.getHostClass(), disabled: this.hasNoFeeds() }, h("h2", null, "News Feed", this.getNeuesteMeldung()), h("ol", null, this.feeds.map((post) => [
...
export { News as honey_news_feed };
