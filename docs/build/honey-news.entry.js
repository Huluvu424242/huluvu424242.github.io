import { g as getRenderingRef, f as forceUpdate, e as Build, r as registerInstance, h, i as Host, j as getElement } from './index-af53bc49.js';
...
const AppShell = class {
  ...
  getHeader() {
    return ([
      h("div", { class: "row flex-spaces" }, h("input", { class: "alert-state", id: "disclaimer", type: "checkbox" }), h("div", { class: "alert alert-danger dismissible" }, h("div", { class: "row" }, h("p", null, "!!! Das ist eine Demo Seite welche alle Feature der App zeigen soll - aus diesem Grund ist auch die Statistik eingeschaltet !!!"), h("div", { class: "background-warning" }, h("p", null, "Es werden nur Daten zu den abgerufenen Feeds gespeichert (in memory) wie: url, anzahl der abfragen, anzahl valider responses"), h("p", null, "Sollten Sie die Speicherung nicht w\u00FCnschen - dann geben Sie bitte keinen neuen Feed ein. Vielen Dank f\u00FCr Ihr Verst\u00E4ndnis."))), h("label", { class: "btn-close", htmlFor: "disclaimer" }, "X"))),
      h("nav", { class: "border split-nav" }, h("div", { class: "nav-brand" }, h("h3", null, h("a", { href: "#" }, "RSS/Atom Feed Reader"))), h("div", { class: "collapsible" }, h("input", { id: "collapsible1", type: "checkbox", name: "collapsible1" }), h("label", { htmlFor: "collapsible1" }, h("div", { class: "bar1" }), h("div", { class: "bar2" }), h("div", { class: "bar3" }), h("div", { class: "bar4" }), h("div", { class: "bar5" })), h("div", { class: "collapsible-body" }, h("ul", { class: "inline" }, h("li", null, h("a", Object.assign({}, href('/feeds')), "Feeds")), h("li", null, h("a", Object.assign({}, href('/')), "News")), h("li", null, h("a", Object.assign({}, href('/statistic')), "Statistik")), h("li", null, h("a", { href: "https://github.com/Huluvu424242/honey-news", target: "_blank" }, "Github")), h("li", null, h("a", Object.assign({}, href('/about')), "About"))))))
    ]);
  }
  render() {
    ...
    return (h(Host, { title: this.getTitleText(), "aria-label": this.getAriaLabel(),
      ...
      class: this.getHostClass() }, h(Router.Switch, null, h(Route, { path: "/" }, this.getHeader(), h("honey-news-feed", null)), h(Route, { path: "/feeds" }, this.getHeader(), h("honey-news-feeds", null)), h(Route, { path: "/statistic" }, this.getHeader(), h("honey-news-statistic", null)), h(Route, { path: "/about" }, this.getHeader(), h("p", null, "Eine SPA auf Basis mehrerer Webkomponenten, gebaut mit Stencil und styled by papercss."), h("p", null, "Das minifizierte Stylesheet von PaperCSS wurde \u00FCber den assets Folder f\u00FCr alle Komponenten zug\u00E4nglich gemacht. Es wurde dann pro Komponente per @import url(...) importiert - was eigentlich ein AntiPattern ist aber ich habe aktuell nix besseres gefunden. Daher - warten auf ConstructedStyleSheets Spec ... Beim @import url(...) hat sich herausgestellt, dass die CSS Properties (Variablen) nicht mit geladen wurden. Daher hab ich diese herausgezogen und unter global/varibales.css eingebunden. Dadurch wird in der index.html folgender Eintrag notwendig:", h("pre", null, "< link rel=\"stylesheet\" href=\"/build/honey-news.css\"/>")), h("p", null, "Das Routing der SPA wurde \u00FCber stencil-router-v2 realisiert. Somit wird bei Klick auf einen Link zwar der URL ge\u00E4ndert aber nicht die ganze Seite neu geladen - was ja praktisch den Kern des Routings in SPAs darstellt."), h("p", null, "F\u00FCr das Backend wurde ein nodejs express server verwendet und auf heroku deployed. Ein separates Backend war leider auf Grund der \u00FCblcihen CORS Problematiken notwendig (CORS-PROXY im Service Worker habe ich leider nicht realisiert bekommen - da hat halt der Browser strikt was dagegen).")))));
  }
