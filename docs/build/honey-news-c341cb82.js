...
const workerPromise = import('./fetch-es6.worker-2b697eab.js').then(m => m.worker);
...
const HoneyNews = class {
  ...
  connectedCallback() {
    ...
    this.statisticSubscription = timer(0, 60000 * 10)
      .pipe(switchMap(() => from(fetch("https://huluvu424242.herokuapp.com/feeds")).pipe(catchError(() => EMPTY))))
      .subscribe((response) => {
      response.json().then((value) => this.statistic = [...value]);
    });
  }
  componentWillLoad() {
    this.loadFeeds();
  ...
  render() {
    ...
    ]))), h("div", { class: "flex-item" }, h("table", null, h("tr", null, h("th", null, "Score"), h("th", null, "Url")), (_a = this.statistic) === null || _a === void 0 ? void 0 :
      _a.map((item) => h("tr", null, h("td", null, item.score), h("td", null, h("a", { href: item.url, target: "_blank" }, item.url)))))))));
  }
